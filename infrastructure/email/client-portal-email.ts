...
type ClientPortalInvitationEmailInput = {
  inviterName: string;
...
/**
 * Same "clean white professional" template as
 * infrastructure/email/financial-email.ts — a client contact expects a
 * plain business email, not the dark EMG participant-facing brand used for
 * survey/certificate emails.
 */
export function renderClientPortalInvitationEmail(input: ClientPortalInvitationEmailInput): {
  subject: string;
  html: string;
} {
  const subject = "You've been invited to view your training programs on CapabilityOS";
            ...
            <tr>
              <td style="padding:32px 32px 0;">
                ...
                <h1 style="margin:12px 0 0;color:#18181B;font-size:20px;line-height:1.4;font-weight:700;">
                  You're invited to your training portal
                </h1>
              </td>
            </tr>
            <tr>
              <td style="padding:20px 32px 0;">
                <p style="margin:0;color:#3F3F46;font-size:14px;line-height:1.6;">
                  <strong style="color:#18181B;">${safeInviter}</strong> from
                  <strong style="color:#18181B;">${safeOrganization}</strong> has given you access to view your
                  organization's training program reports and results.
                </p>
              </td>
            </tr>
            <tr>
